...
{
	const auto dark_error = QColor{0xb0, 0x00, 0x20};
	const auto light_error = QColor{0xff, 0x6b, 0x6b};
	const auto color = contrastRatio(background, dark_error)
