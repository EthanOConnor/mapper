...
// virtual
QGeoAreaMonitorSource* NmeaPositionPlugin::areaMonitor(
...
// virtual
QGeoPositionInfoSource* NmeaPositionPlugin::positionInfoSource(
	QObject* parent, const QVariantMap& /* parameters */)
{
...
// virtual
QGeoSatelliteInfoSource* NmeaPositionPlugin::satelliteInfoSource(
	QObject* /* parent */, const QVariantMap& /* parameters */)
{
	return nullptr;
}
