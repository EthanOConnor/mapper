...
QGeoAreaMonitorSource* PowershellPositionPlugin::areaMonitor(
	QObject* /* parent */, const QVariantMap& /* parameters */)
{
	return nullptr;
}

QGeoPositionInfoSource* PowershellPositionPlugin::positionInfoSource(
	QObject* parent, const QVariantMap& /* parameters */)
{
	return new PowershellPositionSource(parent);
}

QGeoSatelliteInfoSource* PowershellPositionPlugin::satelliteInfoSource(
	QObject* /* parent */, const QVariantMap& /* parameters */)
{
	return nullptr;
}
